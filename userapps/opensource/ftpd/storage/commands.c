...
#if 0	//cbj
void do_fwUpdate(char* filename)
{
    int byteRd = 0;
    char tag[TAG_LEN];
    int tagSize = 0;
    ...
    fQuitCmd = FALSE;
    PFILE_TAG pTag = NULL;
    UPLOAD_RESULT tagResult = UPLOAD_FAIL_ILLEGAL_IMAGE;
...
// cbj add this function call to do "STOR" 
