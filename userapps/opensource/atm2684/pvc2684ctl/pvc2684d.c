...
// brcm
#define GET_NAS_IDX_PORT(I) (((unsigned long) (I) >> 24) & 0xff)
#define GET_NAS_IDX_VPI(I)  (((unsigned long) (I) >> 16) & 0xff)
#define GET_NAS_IDX_VCI(I)  (((unsigned long) (I) >>  0) & 0xffff)
...
void setIndexName(char * str, const char * hdr, int index) {
    ...
    num1 = GET_NAS_IDX_PORT(index);
    num2 = GET_NAS_IDX_VPI(index);
    num3 = GET_NAS_IDX_VCI(index);
    sprintf(str, "%s_%d_%d_%d", hdr, num1, num2, num3);
}
