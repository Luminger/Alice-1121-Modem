...
/*#define DEFAULT_MIBS "IP-MIB:IF-MIB:TCP-MIB:UDP-MIB:SNMPv2-MIB:RFC1213-MIB:NOTIFICATION-LOG-MIB:SNMP-VIEW-BASED-ACM-MIB:SNMP-COMMUNITY-MIB:SNMP-NOTIFICATION-MIB"*/
#define DEFAULT_MIBS "IP-MIB:IF-MIB:TCP-MIB:UDP-MIB:SNMPv2-MIB:RFC1213-MIB:SNMP-COMMUNITY-MIB"
...
//#define STRUCT_DES_KS_STRUCT_HAS_WEAK_KEY 1
...
#define BRCM_SNMP_INFO
#ifdef BRCM_SNMP_INFO
#define ENTERPRISE_OID                  4413
#define ENTERPRISE_MIB                  1,3,6,1,4,1,4413
#define ENTERPRISE_DOT_MIB              1.3.6.1.4.1.4413
#define ENTERPRISE_DOT_MIB_LENGTH       7

/* The assigned enterprise number for sysObjectID. */
#define SYSTEM_MIB		1,3,6,1,4,1,4413.3,2,OSTYPE
#define SYSTEM_DOT_MIB		1.3.6.1.4.1.4413.3.2.OSTYPE
...
#define CONFIGURE_OPTIONS "\" --with-default-snmp-version=2 --with-out-transports=TCP --with-mib-modules=mibII '--with-out-mib-modules=snmpv3mibs ucd_snmp agent_mibs agentx target'\""
...
/*  This is defined if support for the AAL5 PVC transport domain is
    available.  */
#define SNMP_TRANSPORT_AAL5PVC_DOMAIN
