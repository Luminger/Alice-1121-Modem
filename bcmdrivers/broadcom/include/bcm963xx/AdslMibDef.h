 ...
 * $Revision: 1.29 $
 *
 * $Id: AdslMibDef.h,v 1.29 2007/09/04 07:21:15 tonytran Exp $
 *
 * $Log: AdslMibDef.h,v $
...
#define kVdslMibMaxToneNum                  kAdslMibAnnexAToneNum*2*2
...
typedef struct _adslMibInfo {
	...
	union {
		adslChanCounters		xdslChan0PerfIntervals[kAdslMibChanPerfIntervals];
		adslChanCounters		adslChanIntlPerfIntervals[kAdslMibChanPerfIntervals];
	};
	union {
		adslChanCounters		xdslChan1PerfIntervals[kAdslMibChanPerfIntervals];
	...
	bandPlanDescriptor			usBandPlan;
	bandPlanDescriptor			dsBandPlan;
