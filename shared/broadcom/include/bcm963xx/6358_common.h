...
#define UART1_BASE           0xfffe0120  /* uart registers */
...
#define GPIO_SWREG_1P2REG_SHIFT 0x0
#define GPIO_SWREG_1P2REG_MASK  (0xf<<GPIO_SWREG_1P2REG_SHIFT)
#define GPIO_SWREG_2P5REG_SHIFT 0x4
#define GPIO_SWREG_2P5REG_MASK  (0xf<<GPIO_SWREG_2P5REG_SHIFT)
...
#define DDR_UBUS_DESKEW_PHASE_CONFIG    0x48
#define DDR_UBUS_PI_DESKEW      0x4C
#define DDR_UBUS_PI_DESKEW_MONITOR      0x50
