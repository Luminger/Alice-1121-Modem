...
/* DYNAHELPER */
extern void (*dynahelper_trackct)(struct module * m);
extern void (*dynahelper_untrackct)(struct module * m);
extern void (*dynahelper_refct)(struct module * m);
extern void (*dynahelper_unrefct)(struct module * m);
