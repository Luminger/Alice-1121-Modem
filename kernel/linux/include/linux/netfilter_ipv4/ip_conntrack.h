...
struct ip_conntrack_expect
{
	...
	struct ip_conntrack_manip saved_addr;
...
extern void ip_conntrack_expect_taken(struct ip_conntrack_expect *exp);
extern void ip_conntrack_aged(struct ip_conntrack *ct);
...
extern unsigned int isDbgAlg(unsigned int flags);
