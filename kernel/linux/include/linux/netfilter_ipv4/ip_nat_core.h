...
/* DYNAHELPER */
extern void (*dynahelper_tracknat)(struct module * m);
extern void (*dynahelper_untracknat)(struct module * m);
extern void (*dynahelper_refnat)(struct module * m);
extern void (*dynahelper_unrefnat)(struct module * m);
