...
#if defined(CONFIG_BRCM_IKOS)
/* This should be the first kernel function that always links at the same
 * address.  Find the address of this function in the System.map file and
 * set it as the Linux entry point address in the IKOS boot loader.
 */
