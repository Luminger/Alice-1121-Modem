...
/* DYNAHELPER */
void (*dynahelper_tracknat)(struct module * m) = NULL;
void (*dynahelper_untracknat)(struct module * m) = NULL;
...
int ip_nat_helper_register(struct ip_nat_helper *me)
{
	...
	/* DYNAHELPER */
	if (dynahelper_tracknat)
		dynahelper_tracknat(me->me);
...
void ip_nat_helper_unregister(struct ip_nat_helper *me)
{
	...
	if (LIST_FIND(&helpers, helper_cmp, struct ip_nat_helper *,&me->tuple)) {
		...
		/* DYNAHELPER */
		if (dynahelper_untracknat)
			dynahelper_untracknat(me->me);
